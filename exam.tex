...
\newcommand{\answerlong}[1]{\ifkey\color{red}\textbf{#1}\color{black}\else\vspace{2in}\fi\xspace}
...
\item \pts{2}
  Which of the following would make a good milestone in a software project
  \\ \textbf{A}\hspace{0.2in} 50\% done
  \\ \correct{B}\hspace{0.2in}
  \\ \textbf{C}\hspace{0.2in} 
  \\ \correct{D}\hspace{0.2in}
...
\item \pts{4} Consider the following code snippet: \\
  \begin{lstlisting}
  ...
  1. \answershort{replace 3.14 with a PI constant} \\
  2. \answershort{rename ``r'' to ``radius'' or rename ``computeCircumference'' to ``circumference''}
